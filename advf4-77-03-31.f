...
C      IF(A.EQ.'ENTER'.AND.(WD2.EQ.'STREA'.OR.WD2.EQ.'WATER'))GOTO 2010
      IF(CHAR(A).EQ.'ENTER'.AND.(WD2.EQ.'STREA'.OR.WD2.EQ.'WATER'))GOTO
     1 2010
...
1     FORMAT(4A5)
      ...
      IF(((A(J).NEQV.O"201004020100").AND.MASK1).EQ.0)GOTO 3
      IF(S.EQ.0) GOTO 2
      TWOW=1
...
11    RES = ((RES.AND.O"377777777777")/2) + J
20    RETURN
30    DO 31 I=1,DIST
      j = 0
      IF ((RES.AND.O"200000000000").NE.0) J=O"400000000000"
31    RES = (RES.AND.O"177777777777")*2 + J
      RETURN
      END
