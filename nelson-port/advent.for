...
C
     ...
     1 BINFIL='/data/nelson-port/advent.bin')
C
...
1005  FORMAT(I8,A70,A)
      IF(AA.NE.' ')CALL BUG(0)
      WRITE(*,5999) 'Loc checking if eq -1 = ', LOC
5999  FORMAT(A,I1)      
...
71    IF(NEWLOC.EQ.LOC.OR.FORCED(LOC).OR.BITSET(LOC,3))GOTO 74
      ...
      NEWLOC=LOC
      WRITE(*,7996) 'NEWLOW = LOC', LOC
7996  FORMAT(A,I1)      
      CALL RSPEAK(2)
      GOTO 74
73    CONTINUE
74    LOC=NEWLOC
      WRITE(*,7995) 'Loc = Newloc', LOC
7995  FORMAT(A,I1)
...
6027  DTOTAL=DTOTAL+1
      ...
      WRITE(*,7994) 'IF(KNFLOC.GE.0)KNFLOC=LOC ', LOC
7994  FORMAT(A,I1)      
